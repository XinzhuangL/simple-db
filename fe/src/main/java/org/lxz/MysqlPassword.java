...
public class MysqlPassword {
    ...
    public static boolean checkScramble(byte[] scramble, byte[] message, byte[] hashStage2) {
        ...
        try {
            ...
            System.out.println("No SHA-1 Algorithm when compute password");
            return false;
        }
    ...
    public static byte[] getSlatFromPassword(byte[] password) {
    ...
    public static byte[] checkPassword(String passwdString) {
        ...
        if (passwd.length != SCRAMBLE_LENGTH_HEX_LENGTH || passwd[0] != PVERSION41_CHAR) {
            System.out.println("Error passwd length");
        }
